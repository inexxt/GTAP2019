...
diamond .(_ ∷ _ ∷ r) m2 m3 (cancel≅ [] r .(_ ∷ _ ∷ r) .m2 refl defmf) (bs≅ (x ∷ x₁ ∷ l) r₁ .(_ ∷ _ ∷ r) .m3 defm₁ defmf₁) = {!!}
diamond .(_ ∷ _ ∷ r) m2 m3 (swap≅ x [] r .(_ ∷ _ ∷ r) .m2 refl defmf) (bs≅ (x₁ ∷ x₂ ∷ l) r₁ .(_ ∷ _ ∷ r) .m3 defm₁ defmf₁) = {!!}
diamond .(suc _ ∷ _ ∷ suc _ ∷ r) m2 m3 (braid≅ [] r .(suc _ ∷ _ ∷ suc _ ∷ r) .m2 refl defmf) (bs≅ (x ∷ x₁ ∷ x₂ ∷ l) r₁ .(suc _ ∷ _ ∷ suc _ ∷ r) .m3 defm₁ defmf₁) = {!!}
diamond .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r) m2 m3 (bs≅ [] r .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r) .m2 refl defmf) (bs≅ (x ∷ x₁ ∷ x₂ ∷ x₃ ∷ l) r₁ .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r) .m3 defm₁ defmf₁) = {!!}
diamond .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) m2 m3 (cancel≅ (x ∷ x₁ ∷ x₂ ∷ x₃ ∷ l) r .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m2 defm defmf) (bs≅ [] r₁ .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m3 refl defmf₁) = {!!}
diamond .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) m2 m3 (swap≅ x (x₁ ∷ x₂ ∷ x₃ ∷ x₄ ∷ l) r .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m2 defm defmf) (bs≅ [] r₁ .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m3 refl defmf₁) = {!!}
diamond .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) m2 m3 (braid≅ (x ∷ x₁ ∷ x₂ ∷ x₃ ∷ l) r .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m2 defm defmf) (bs≅ [] r₁ .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m3 refl defmf₁) = {!!}
diamond .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) m2 m3 (bs≅ (x ∷ x₁ ∷ x₂ ∷ x₃ ∷ l) r .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m2 defm defmf) (bs≅ [] r₁ .(suc (suc _) ∷ suc _ ∷ _ ∷ suc (suc _) ∷ r₁) .m3 refl defmf₁) = {!!}
